module Mailboxer
  module Models
    module Messageable
      ...
      #as originator
      def send_message(recipients, msg_body, subject, sanitize_text=true, attachments=nil)
        convo = Conversation.new({:subject => subject})
        message = messages.new({:body => msg_body, :subject => subject, :message_attachments_attributes => attachments})
      ...
      def reply(conversation, recipients, reply_body, subject=nil, sanitize_text=true, attachments=nil)
        ...
        response = messages.new({:body => reply_body, :subject => subject, :message_attachments_attributes => attachments})
      ...
      def reply_to_sender(receipt, reply_body, subject=nil, sanitize_text=true, attachments=nil)
        return reply(receipt.conversation, receipt.message.sender, reply_body, subject, sanitize_text, attachments)
      end
      ...
      def reply_to_all(receipt, reply_body, subject=nil, sanitize_text=true, attachments=nil)
        return reply(receipt.conversation, receipt.message.recipients, reply_body, subject, sanitize_text, attachments)
      end
      ...
      def reply_to_conversation(conversation, reply_body, subject=nil, should_untrash=true, sanitize_text=true, attachments=nil)
        ...
        return reply(conversation, conversation.last_message.recipients, reply_body, subject, sanitize_text, attachments)
      end
